...
class LanguageAdapter1(private val itemClickCallback: (LanguageModel) -> Unit, private val alertDialog: AlertDialog)
    : ListAdapter<LanguageModel, LanguageAdapter1.LanguageViewHolder>(LanguageDiffCallback()) {
